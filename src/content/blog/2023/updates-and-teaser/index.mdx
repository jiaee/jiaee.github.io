...
description: 'A long awaited update and announcements, as well as a small teaser for an upcoming blog post.'
date: 'Nov 17 2023'
slug: updates-and-teaser
tags: ['blog', '2023']
authors: ['flocto']
image: './hero.png'
---
...
Anyway, first things first, I think I'll be moving away from Hugo in the upcoming months. I've been looking at ~~[eleventy](https://www.11ty.dev/)~~ [Astro](https://astro.build) recently and it looks pretty promising. Hopefully the shift doesn't break too many of my old posts, but if they do just know I won't be fixing them. ~~cuz im lazy~~
